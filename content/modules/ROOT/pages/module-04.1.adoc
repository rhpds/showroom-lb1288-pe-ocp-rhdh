...
Argo is tuned to pull changes from the repo every two minutes or so. +
Instead of waiting that to kick in, 

* https://openshift-gitops-server-openshift-gitops.{openshift_cluster_ingress_domain}[click here^, window="_argo"] to login 
* *username*: admin
...
* The card will turn green when it is ready. Go ahead and refresh RHDH
