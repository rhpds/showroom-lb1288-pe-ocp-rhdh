...
. Highlight the YAML as shown in the below screenshot, and comment those lines. Type *Ctrl+ /* command to do so.
+
...
. The Systems and Domain are setup. These help to form important abstraction level to help us reason about software ecosystems.
