...
.Click to learn more about `react-jsonschema-form` library
[%collapsible]
====
...
* Best practices about this sandbox env being created  in developer's personal git repo and personal Quay
...
If prompted, login as *(pe1/{common_password})*
