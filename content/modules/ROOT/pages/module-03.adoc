...
Until now, you've been acting in the role of a platform engineer. Let's switch persona to that of a developer. 
...
. Visit the https://quay.{openshift_cluster_ingress_domain}[Quay Registry] deployed in your workshop environment.
...
. Visit the https://gitlab-gitlab.apps.cluster-gl28t.gl28t.sandbox776.opentlc.com/rhdh/developer-hub-config/-/blob/main/values.yaml[rhdh/developer-hub-config/values.yaml] file.
...
. Visit the https://gitlab-gitlab.apps.cluster-gl28t.gl28t.sandbox776.opentlc.com/pe1/my-quarkus-app/-/blob/main/catalog-info.yaml[dev1/my-quarkus-app/catalog-info.yaml] file in GitLab.
