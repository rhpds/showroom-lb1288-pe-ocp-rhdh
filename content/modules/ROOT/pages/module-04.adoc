...
== Platform Engineer:  Software template to import existing applications
...
=== Platform Engineer:  Explore the `import-app` Software Template

Since you have already learnt how to create a Softar Template, we will walk through a template that has been built for you. This template does the following things

. Gather details of where this Envelope repo lives
. Gather details of the application that needs to be onboarded
. Gather details of the application's dependencies, required integrations on the Developer Hub etc
