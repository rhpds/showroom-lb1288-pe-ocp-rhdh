...
. The feature request is to expose a REST API call which will return the total number of products available. For the sake of the workshop, we will (again) uncomment some code.
