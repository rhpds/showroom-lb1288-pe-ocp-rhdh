...
IMPORTANT: Please make sure you are logged in as a *Developer* with `dev1/{common_password}`. If you are unsure how to, please refer to the below note.
...
. Choose the *Create* side menu, and you will see the *Parasol Store Development* template. Click on *Choose*.
+
