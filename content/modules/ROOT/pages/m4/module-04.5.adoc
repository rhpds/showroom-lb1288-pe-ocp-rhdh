...
* Click here to access the repo https://gitlab-gitlab.{openshift_cluster_ingress_domain}/parasol/parasol-store[https://gitlab-gitlab.{openshift_cluster_ingress_domain}/parasol/parasol-store^, window="gitlab"]
...
* From Developer Hub, access `parasol-store-my-feature-branch` component https://backstage-backstage.{openshift_cluster_ingress_domain}/catalog/default/component/parasol-store-my-feature-branch/ci[from here^, window="rhdh"] 
