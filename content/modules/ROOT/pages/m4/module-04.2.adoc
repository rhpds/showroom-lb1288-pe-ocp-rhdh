...
+
NOTE: This YAML snippet enables auto-discovery for all files named _envelope.yaml_ (entityFilename) where the repo name starts with the word _envelope_ (projectPattern). 
