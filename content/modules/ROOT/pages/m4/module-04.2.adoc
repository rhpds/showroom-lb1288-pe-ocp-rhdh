...
.Click to learrn how to login as a Platform Engineer
[%collapsible]
====
...
. Click on the *Create* icon in the top navigation. 
+
...
.. If that is not accessible anymore, click *(+)* create icon (top nav) -> *Register Existing Component* (top right)
