...
NOTE: Auto-discovery can be configured with a _schedule_ that defines how often you want it to run. In real world, be judicious with the scheduling frequency so as not to hit API rate limits with your Git hosting provider. https://backstage.io/docs/integrations/github/discovery/[Learn more^, window="content"] about GitHub rate limits.
