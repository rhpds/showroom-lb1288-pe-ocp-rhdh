...
. Click on the *(+)* create icon from the top navigation, and click the *Choose* button on the *Import Existing API* Template.
+
...
. Click the *Create* *(+)* icon in the top-menu of {product_name_rhdh}.
