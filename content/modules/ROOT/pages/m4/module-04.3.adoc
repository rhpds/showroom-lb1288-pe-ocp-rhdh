...
| Repository Name | Enter value | `parasol-store`
|====
+
...
|====
| *Field* | *Description* | *Value*
| Component GitLab Organization | Organization where the repository resides
| `parasol`
| Component Repository Name | enter this value | `envelope-parasol-catalog` 
| Component Name of the App | enter this value | `parasol-store`
| Owner | Choose from dropdown | `group:default/dev1`
