...
. Select the image:common/plus-icon.png[width=15px] icon on the top navigation bar to access the *Create* menu, and click the *Choose* button on the *Import Existing API* Template.
+
...
. Select the image:common/plus-icon.png[width=15px] icon on the top navigation bar to access the *Create* menu of {product_name_rhdh}.
