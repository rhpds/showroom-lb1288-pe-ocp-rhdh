...
+
image:m4/api-template-merge-component.png[]
.. Open PR with catalog-info.yaml
+
image:m4/api-template-merge-envelope.png[]
...
Fill out the following values in the wizard similar by going through the steps. Refer to the following table for the data for each step
...
.. Open PR for update to catalog envelope
+
image:m4/app-template-merge-component.png[]
.. Open PR with catalog-info.yaml
+
image:m4/app-template-merge-envelope.png[]
...
You can now optionally import  parasol-web  component as well.
