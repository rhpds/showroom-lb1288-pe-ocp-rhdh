...
. Creating a Realm and Client in Red Hat Single Sign-On. These have been pre-configured for you. View the `backstage` Realm using the following URL and credentials:
    * *URL*: https://sso.{openshift_cluster_ingress_domain}/admin/master/console/#/backstage[https://sso.{openshift_cluster_ingress_domain}/admin/master/console/#/backstage^, window="sso"]
