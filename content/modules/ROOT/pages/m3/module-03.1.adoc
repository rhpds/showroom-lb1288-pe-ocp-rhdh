...
The `output` values are documented on a per plugin basis. You can find the values for the specific version of your installed plugins by accessing the https://backstage-backstage.{openshift_cluster_ingress_domain}/edit/actions[/edit/actions^, window="rhdh"] endpoint on your {product_name_rhdh} instance.
