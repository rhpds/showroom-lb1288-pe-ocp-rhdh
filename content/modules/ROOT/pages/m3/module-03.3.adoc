...
IMPORTANT: Please make sure to log in as a *Developer* with *dev1/{common_password}* as described in the next step to avoid errors while navigating this workshop :)
