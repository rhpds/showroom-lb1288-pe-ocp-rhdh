...
With the development inner-loop complete, the code running in the developer's isolated feature-branch namespace is now ready for deployment to Dev, Staging, and Production environments.
...
* Once merged, the pipeline updates manifests in the Dev and Staging environments. Additionally, it raises a pull request (PR) for the Production manifest.
