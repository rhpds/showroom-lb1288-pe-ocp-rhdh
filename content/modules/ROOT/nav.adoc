...
** xref:m6/module-06.2.adoc[6.2 Adding Dependency Analytics for Developers]
** xref:m6/module-06.3.adoc[6.3 __Optional__ - Add git signing and verification]
** xref:m6/module-06.4.adoc[6.4 Adding image signing]
** xref:m6/module-06.5.adoc[6.5 Adding image verification]
** xref:m6/module-06.6.adoc[6.6 Adding build attestations]
** xref:m6/module-06.7.adoc[6.7 Adding attestation verification]
