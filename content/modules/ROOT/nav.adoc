...
** xref:m2/module-02.3.adoc[2.3 Activity: Synchronize User & Group Entities]
** xref:m2/module-02.4.adoc[2.4 Activity: Configure OpenID Connect Authentication]
** xref:m2/module-02.5.adoc[2.5 Activity: Enabling GitLab Entity Discovery & TechDocs]

* xref:m3/module-03.0.adoc[3. Test drive Red Hat Developer Hub]
